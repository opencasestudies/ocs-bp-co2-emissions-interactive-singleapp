...
library(learnr)
library(gradethis)
# Note: if you do not have the `gradethis` package, you will need to install it first
...
library(forcats)
library(ggplot2)
# Note: Please ensure that you have the latest version of the `ggplot2` package 
# using update.packages("ggplot2")
